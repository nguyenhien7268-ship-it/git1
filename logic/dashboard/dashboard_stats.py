"""
dashboard_stats.py - Statistics functions

Contains lottery statistics calculation functions extracted from dashboard_analytics.py
Functions: get_loto_stats_last_n_days, get_loto_gan_stats
"""
