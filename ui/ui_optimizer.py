...
class OptimizerTab(ttk.Frame):
    ...
    def __init__(self, parent_notebook, app_instance):
        ...
        strategy_frame = ttk.Labelframe(
            settings_frame, text="1. Cài đặt Chiến lược", padding="10"
        )
        strategy_frame.grid(row=0, column=0, sticky="ew")
        strategy_frame.columnconfigure(1, weight=1)

        ttk.Label(strategy_frame, text="Chiến lược Tối ưu:").grid(
        ...
        ttk.Label(strategy_frame, text="Số ngày kiểm thử:").grid(
        ...
        params_frame = ttk.Labelframe(
            settings_frame, text="2. Chọn Tham số để Tối ưu Hóa", padding="10"
        )
        ...
        ttk.Label(header_frame, text="Tham số", font=("TkDefaultFont", 9, "bold")).grid(
            row=0, column=1
        )
        ttk.Label(header_frame, text="Từ", font=("TkDefaultFont", 9, "bold")).grid(
            row=0, column=2
        )
        ttk.Label(header_frame, text="Đến", font=("TkDefaultFont", 9, "bold")).grid(
            row=0, column=3
        )
        ttk.Label(
            header_frame, text="Bước nhảy", font=("TkDefaultFont", 9, "bold")
        ).grid(row=0, column=4)
        ...
        self.run_button = ttk.Button(
            settings_frame,
            text="Bắt đầu Tối ưu Hóa Chiến lược",
        ...
        self.apply_button = ttk.Button(
            settings_frame,
            text="Áp dụng Cấu hình Tốt nhất",
        ...
        tree_frame = ttk.Labelframe(
            results_frame,
            text="3. Kết quả Tối ưu (Xếp hạng theo Tỷ lệ thắng)",
            padding="10",
        )
