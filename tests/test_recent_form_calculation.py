# test_recent_form_calculation.py - Đã sửa lỗi Mâu thuẫn Mock

import unittest
from unittest.mock import patch, MagicMock

# Import hàm cần kiểm tra
# Sẽ hoạt động vì test chạy từ thư mục gốc.
...
MOCK_ALL_DATA = [
    ...
    *[[f'25112903{i}', '12345', '1234', '123', '12', '1'] for i in range(1, 20)], # 19 dòng dữ liệu giả
]
...
def mock_validate_params(data, start, end):
    ...
    # Trả về 5 giá trị như chữ ký hàm production
...
class TestRecentFormCalculation(unittest.TestCase):
    ...
    # Định nghĩa lại MOCK_VALIDATE_PARAMS để khớp với chữ ký (signature) của hàm production
